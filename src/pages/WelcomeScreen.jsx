...
const WelcomeScreen = ({ onLogin, onSignup }) => {
  return (
    ...
    >
      <h2 className="text-3xl font-bold text-center text-[#b39bc8]">
        Welcome to Nihonga
      </h2>
      ...
      <div className="flex flex-col gap-4 w-full max-w-xs">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          onClick={onSignup}
          className="w-full bg-[#e9f3ff] text-[#d2b3db] py-3 rounded-2xl font-semibold shadow-md hover:shadow-lg transition"
        >
          Signup
        </motion.button>
      </div>
