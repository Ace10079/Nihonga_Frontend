    ...
    <div className="bg-gray-100 shadow-md">
      ...
      <div className="relative flex items-center justify-between px-4 py-3">
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 font-bold text-lg">
          <img src="/IMG_6381.JPG" alt="Logo" className="h-10 w-auto" />
        </div>
      ...
      <div
        ...
        } bg-white px-4 border-t border-b`}
      >
        <input
          type="text"
      ...
      >
        ...
        <nav className="flex flex-col p-4 space-y-4">
          ...
          <NavLink to="/collections" onClick={() => setIsMenuOpen(false)}>Collections</NavLink>
